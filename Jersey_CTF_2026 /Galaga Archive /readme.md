...
Sau 1 giai đoạn client này thực hiện kết nối đến các domain khong quá quan trọng trong challenge này như `\\DC-1\IPC$`, `\\DC-01\SYSVOl`, thì client thực hiện tải các file trong domain chia sẽ dữ liệu trong hệ thống này là `\\DC-01\GalaTwo` bằng giao thức `smb2`.
